...
print(f"Průměrné FPS pro MainMenu (včetně Settings): {calc_avg(mainmenu_sum, mainmenu_count):.2f}")
print(f"Průměrné FPS pro Lobby (LobbyMenza/LobbyG): {calc_avg(lobby_sum, lobby_count):.2f}")
